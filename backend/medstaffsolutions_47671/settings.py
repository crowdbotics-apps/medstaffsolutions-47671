"""
Django settings for medstaffsolutions_47671 project.
...
ROOT_URLCONF = 'medstaffsolutions_47671.urls'
...
WSGI_APPLICATION = 'medstaffsolutions_47671.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "medstaffsolutions_47671 API",
    "DESCRIPTION": "API documentation for medstaffsolutions_47671 App",
    "VERSION": "v1",
}
